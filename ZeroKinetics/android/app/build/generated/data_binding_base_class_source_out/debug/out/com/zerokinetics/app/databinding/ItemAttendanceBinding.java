...
public final class ItemAttendanceBinding implements ViewBinding {
  ...
  private ItemAttendanceBinding(@NonNull LinearLayout rootView, @NonNull TextView tvScore,
  ...
  public static ItemAttendanceBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemAttendanceBinding((LinearLayout) rootView, tvScore, tvStatus, tvStudentName);
    }
